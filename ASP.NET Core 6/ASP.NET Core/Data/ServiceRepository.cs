...
namespace fixit.Data
{
    public class ServiceRepository : IRepository<Service>
    {
        ...
        public async Task<bool> DeleteData(Service service)
        {
            ...
            _context.Parking.Remove(service);
        ...
        public async Task<List<Service>> GetData()
        {
            ...
            var model = await _context.Parking.ToListAsync();
            return model;
        ...
        {
            return await _context.Parking.FirstOrDefaultAsync(x => x.ServiceId == id);
        }
